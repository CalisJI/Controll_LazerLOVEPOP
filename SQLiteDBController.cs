...
{
    public static class SQLDBController
    {
        public static string Rootpath = Directory.GetCurrentDirectory() + @"\DB";
        public static string DbName = "AppDB.db";
        public static void ApplyTable(DataTable dataTable)
        {
            ...
            using (SqliteConnection connection = new SqliteConnection($"Data Source={Rootpath+@"\"+DbName}"))
            {
        ...
        static void CreateTableAndInsertData(SqliteConnection connection, DataTable dataTable, DateTime dateTime)
        {
